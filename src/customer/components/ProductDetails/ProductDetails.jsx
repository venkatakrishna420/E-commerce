      ...
      <div className="pt-6">
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
          ...
          <div className="flex flex-col items-center">
            ...
            {product.images.map((item)=><div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] max-h-[5rem] mt-4">
                <img
                  src={item.src}
                  alt={item.alt}
                  className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            <div className="lg:col-span-2 ">
              <h1 className="text-lg lg:text-xl font-semibold text-grey-900">Universaloutfit</h1>
              <h1 className='text-lg lg:text-xl text-grey-900 opacity-60 pt-1'>
                Casual Tshirts Solid Men White&Gery Tshirts
              </h1>
            </div>
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='opacity-50 text-sm'>5660 Ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 
                  hover:text-indigo-500'>3870 Reviews</p>
                </div>
          ...
          <Grid container spacing={7}>
           ...
           <Grid item xs={5}>
            ...
            <div className='flex item-center space-x-3'>
              ...
              <p className='opacity-60'>5949 Ratings</p>
            </div>
